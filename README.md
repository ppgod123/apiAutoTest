...
> 可以考虑使用Anaconda进行搭建虚拟环境[https://blog.csdn.net/u012308586/article/details/89447372](https://blog.csdn.net/u012308586/article/details/89447372)

> 推荐使用3.7版本[https://docs.anaconda.com/anaconda/packages/oldpkglists/](https://docs.anaconda.com/anaconda/packages/oldpkglists/)
...
如果使用的是anaconda已安装的3.7虚拟环境，则在`cmd`中输入`conda activate xxxx`激活环境，再输入
...
### 如何发送post请求
    ...
    collect_addtool_01:
        ...
        data:
          ...
          link: https://gitee.com/yu_xiao_qi/apiAutoTest
        # 是否有依赖业务，为空或者false则表示没有
        dependence_case: False
            # 依赖的数据
        dependence_case_data:
